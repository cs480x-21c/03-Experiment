...
```{r}
d <- ggplot(cars, aes(Cylinders, Weight)) + geom_point()
d + stat_summary(fun.data = "mean_cl_boot", colour = "red", size = 2) + stat_summary(fun.data = mean_cl_boot, geom = "errorbar", colour = "red")
```
